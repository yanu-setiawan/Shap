    ...
    <section className="w-full relative flex  flex-col items-center justify-center px-4 md:px-0 py-8">
      ...
      <Wrapper>
        ...
        <Container>
          <div className="flex flex-col items-center justify-center py-20 w-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl m-auto w-11/12 md:w-full">
            ...
            <div className="relative flex  justify-center mx-auto items-center py-10 md:py-20 w-full">
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <Container className="max-w-md mx-auto text-start md:text-center">
          ...
          <p className="text-muted-foreground mt-6">
            Shap offers a range of features to help you build a stunning
            websites in no time
          </p>
        </Container>
        <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full gap-8">
              {features.map((feature) => (
                ...
                >
                  ...
                  <p className="text-muted-foreground mt-2 text-center md:text-start">
                    {feature.info}
                  </p>
                </div>
              ))}
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Choose the best plan for your business start building your dream
              website today
            </p>
          </div>
        </Container>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center ">
            ...
            <h2 className="text-3xl lg:text-4xl font-serif mt-6 font-semibold">
              What people are saying
            </h2>
            <p className="text-muted-foreground mt-6">
              See how Shap empowers business of all sizes. Here&apos;s what real
            ...
            <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden py-10">
              <Marquee pauseOnHover className="[--duration:20s] select-none">
                {firstRow.map((review) => (
                  ...
                  >
                    <div className="flex flex-rowb items-center gap-2">
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center ">
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto ">
                Build stunning website with Shap&apos;s intuitive drag-and-drop
                builder and powerfull AI Assistant
              </p>
